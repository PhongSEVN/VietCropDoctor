"""Dataset implementation for MobileNetV3 plant disease classification."""
import torch
...
class MobileNetV3ImageDataset(Dataset):
    """Image dataset for MobileNetV3."""
    ...
    def __init__(
        ...
        """
        Initialize MobileNetV3ImageDataset.
        ...
        for cls in self.classes:
            ...
            for img_name in os.listdir(cls_path):
                if img_name.lower().endswith((".jpg", ".jpeg", ".png", ".bmp", ".gif")):
                    self.samples.append((cls_path / img_name, self.class_to_idx[cls]))
