"""Validation script for MobileNetV3."""
import sys
...
from cv.MobileNetV3.dataset import MobileNetV3ImageDataset
from cv.MobileNetV3.model import build_mobilenetv3_model
...
def main():
    ...
    models_dir = PROJECT_ROOT / cfg["output"].get("models_dir", "cv/results/mobilenetv3/models")
    results_dir = PROJECT_ROOT / cfg["output"].get("results_dir", "cv/results/mobilenetv3")
    results_dir.mkdir(parents=True, exist_ok=True)

    # Load dataset
    print("Loading validation dataset...")
    val_ds = MobileNetV3ImageDataset(
        dataset_root / "val", cfg,
        image_size=cfg["dataset"]["image_size"], train=False,
    )
